function Calculator() {
    ...
    this.btnSin = document.createElement('button');
    this.btnSin.innerHTML = "sin";
    this.btnCos = document.createElement('button');
    this.btnCos.innerHTML = "cos";
    this.btnTg = document.createElement('button');
    this.btnTg.innerHTML = "tg";
...
function open(){
    ...
    calc.btnSin.onclick=function(){
      calc.trigS();
    }
    calc.btnCos.onclick=function(){
      calc.trigC();
    }
    calc.btnTg.onclick=function(){
      calc.trigT();
    }
  ...
  Calculator.prototype.display = function (body) {
      ...
      this.box.appendChild(document.createElement('br'));
      this.box.appendChild(this.btnSin);
      this.box.appendChild(this.btnCos);
      this.box.appendChild(this.btnTg);
  ...
  Calculator.prototype.trigS = function () {
  this.disp.value=Math.sin(this.cur);
  };
  // Calculator.prototype.trigС = function () {
   //this.disp.value=Math.cos(this.cur);
  //};
  Calculator.prototype.trigT = function () {
  this.disp.value=Math.tan(this.cur);
  };
